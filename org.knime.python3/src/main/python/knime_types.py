...
# ---------------------------------------------------------------
class PandasToArrowColumnConverter(ABC):
    """
...
class ArrowToPandasColumnConverter(ABC):
    """
...
_pandas_to_arrow_column_converters = []
_arrow_to_pandas_column_converters = []


def get_first_matching_pandas_to_arrow_col_converter(dtype):
    for c in _pandas_to_arrow_column_converters:
        if c.can_convert(dtype):
            return c
    return None


def get_first_matching_arrow_to_pandas_col_converter(dtype):
    for c in _arrow_to_pandas_column_converters:
        if c.can_convert(dtype):
            return c
    return None
